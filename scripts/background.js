...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  var Storage = function () {
    ...
    _createClass(Storage, [{
      ...
      key: 'saveOriginal',
      value: function saveOriginal(name, title, body, videotag, callback) {
      ...
      value: function _saveTemplate(type, template, callback) {
        ...
        template.id = this._createTemplateId(template.name + template.title + template.body + template.videotag);
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  var Background = function () {
    ...
    _createClass(Background, [{
      ...
      key: 'saveTemplate',
      value: function saveTemplate(name, title, body, videotag) {
        this.storage.saveOriginal(name, title, body, videotag);
      }
        ...
        new Promise(function (resolve, reject) {
          ...
          loop(function () {
            ...
            return new Promise(function (resolve) {
              ...
              _this5.storage.saveOriginal(template.name, template.title, template.body, template.videotag, function () {
                resolve();
              });
            });
          }).then(function () {
